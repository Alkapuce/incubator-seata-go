...
- 新增 XAConn 显式事务回归测试，覆盖 MariaDB、Oracle 和达梦 XA resource 选择、一阶段上报、回滚上报，以及 TC 上报失败时的 prepared branch 保留行为
- 新增 XAResourceManager 回归测试，覆盖 MariaDB、Oracle 和达梦二阶段 commit/rollback 通过 held XA connection 执行并释放 keeper
